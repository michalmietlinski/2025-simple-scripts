...
class DatabaseManager:
    ...
    def create_tables(self):
        ...
        try:
            ...
            # Create template_variables table - Changed "values" to value_list to avoid reserved keyword
            self.cursor.execute('''
    ...
    def get_prompt_history(self, limit=50, offset=0, search=None, favorites_only=False, tags=None, prompt_id=None):
        ...
        Args:
            ...
            prompt_id (int, optional): Get a specific prompt by ID. Defaults to None.
    ...
    def get_generation_history(self, limit=20, offset=0, prompt_id=None, batch_id=None, date_from=None, date_to=None, generation_id=None):
        ...
        Args:
            ...
            generation_id (int, optional): Get a specific generation by ID. Defaults to None.
